...
var	pre_if_HTML1A_TA1_19={type: jsPsychHtmlKeyboardResponse,
    timeline: [{stimulus: '<p style=font-size:48px;><br><br>+<br><br></p>', choices:'ALL_KEYS', stimulus_duration:500, trial_duration:500, response_ends_trial:false, prompt:'<p>Press Z for a real word, press M for a pseudoword</p>'},   {prompt:'<p>Press Z for a real word, press M for a pseudoword</p>', stimulus: '<p style=font-size:48px;><br><br>  DUFCILFTY    <br><br></p>',  stimulus_duration:500, trial_duration: 500, choices:'ALL_KEYS',response_ends_trial:false}, {prompt:'<p>Press Z for a real word, press M for a pseudoword</p>', stimulus: '<p style=font-size:48px;><br><br> ##########    <br><br></p>', stimulus_duration: 500, trial_duration: 500, choices:['z','m'], response_ends_trial: false}],
...
var	pre_if_HTML1A_TB2_66={type: jsPsychHtmlKeyboardResponse,
    timeline: [{stimulus: '<p style=font-size:48px;><br><br>+<br><br></p>', choices:'ALL_KEYS', stimulus_duration:500, trial_duration:500, response_ends_trial:false, prompt:'<p>Press Z for a real word, press M for a pseudoword</p>'}, {prompt:'<p>Press Z for a real word, press M for a pseudoword</p>', stimulus: '<p style=font-size:48px;><br><br>    PERTREN <br><br></p>', stimulus_duration:500, trial_duration: 500, choices:'ALL_KEYS',response_ends_trial:false}, {prompt:'<p>Press Z for a real word, press M for a pseudoword</p>', stimulus: '<p style=font-size:48px;><br><br>  #######<br><br></p>', stimulus_duration: 500, trial_duration: 500, choices:['z','m'], response_ends_trial: false}],
